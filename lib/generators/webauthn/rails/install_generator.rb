    ...
    class InstallGenerator < ::Rails::Generators::Base
      ...
      def inject_js_packages
        if using_importmap?
          ...
          append_to_file "config/importmap.rb", %(pin "@github/webauthn-json/browser-ponyfill", to: "@github--webauthn-json--browser-ponyfill.js"\n)
        elsif using_bun?
          say "Adding webauthn-json/browser-ponyfill to your package manager"
