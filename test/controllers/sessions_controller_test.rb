...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  test "should initiate registration successfully" do
    ...
    post webauthn_rails.get_options_session_url, params: { session: { username: "alice" }, format: :turbo_stream }
  ...
  test "should return error if creating session with blank username" do
    post webauthn_rails.get_options_session_url, params: { session: { username: "" }, format: :turbo_stream }
